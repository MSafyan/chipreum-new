...
type CreatePostProps = {
  setPosts: React.Dispatch<React.SetStateAction<Post[]>>; // or any[] or unknown[] depending on your use case
  setLoader: React.Dispatch<React.SetStateAction<boolean>>;
};

const CreatePost: React.FC<CreatePostProps> = ({ setPosts, setLoader }) => {
  ...
  return (
    <form onSubmit={createPostHandle} className="create-post">
      ...
      <div id="post-btn" className="post-btn d-block">
        <button type="submit" className="enable" disabled={disablePostBtn}>
          post
        </button>
      </div>
    </form>
